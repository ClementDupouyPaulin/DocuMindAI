...
Revision ID: 5a667b962f46
Revises: f8a0b742b73f
Create Date: 2026-05-01 17:47:09.272327
...
revision: str = "5a667b962f46"
down_revision: Union[str, Sequence[str], None] = "f8a0b742b73f"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("retrieved_chunks_json", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index(
        op.f("ix_rag_queries_conversation_id"), "rag_queries", ["conversation_id"], unique=False
    )
